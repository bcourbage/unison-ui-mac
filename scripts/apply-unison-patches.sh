...
REQUIRED_PATCHES="0002-uimacbridge-register-closeConnection.patch 0003-remote-close-and-drain.patch 0004-remote-transport-child-reaper.patch 0005-uimacbridge-sync-completion-snapshot.patch 0006-uimacbridge-register-lock.patch 0007-uarg-prefs-session-argv.patch 0008-uimacbridge-session-argv.patch"
