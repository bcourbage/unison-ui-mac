...
REQUIRED_PATCHES="0002-uimacbridge-register-closeConnection.patch 0003-remote-close-and-drain.patch 0004-remote-transport-child-reaper.patch 0005-uimacbridge-sync-completion-snapshot.patch"
