...
| SHA-256 | `ecbcb8df6f8986472437d83bfdacfaaafc5b0d779d2a4c7e775db2d833da95b1` |
...
| Size | 5.5 MB (5479472 bytes) |
| Built from | builder commit `572824c` on `feat/cli-session-engine-integration`, workflow run <https://github.com/bcourbage/unison-ui-mac/actions/runs/34673189947> (provenance manifest attached to that run). |
