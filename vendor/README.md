...
| SHA-256 | `fbe622c920badb4bac319801ed04df13ee57967203ae6ed399653ac7e82da5cc` |
...
| Size | 5.5 MB (5487304 bytes) |
| Built from | builder commit `6e086d9` on `feat/cli-launch-arg-delivery`, workflow run <https://github.com/bcourbage/unison-ui-mac/actions/runs/34707207364> (provenance manifest attached to that run). This is the first run on the repaired workflow: it completed fully green, including the post-upload XcodeGen install and the build+test-against-the-fresh-blob smoke step. |
